  ...
  const interventions = [
    {
      ...
      description: 'Issue take-home naloxone kit (2x 4mg intranasal Narcan) before ED discharge. Provide bystander training.',
      provider: 'UK HealthCare BRIGHT Program',
      timeline: 'Today — before discharge',
      rationale: 'Poly-substance use (fentanyl + benzos) significantly delays Narcan reversal. Multiple household members need training.',
    },
    {
      priority: 'immediate',
      color: '#ef4444',
      ...
      description: 'ED-based buprenorphine (Suboxone) induction. Begin with 4mg, titrate to 16mg/day. Bridge script for 7 days.',
      provider: 'BluegrassMAT Clinic (warm handoff)',
    ...
    },
    {
      ...
      description: 'Assign dedicated peer specialist (Tanya Williams has prior relationship). Daily check-ins for first 2 weeks.',
      provider: 'Lexington Recovery Coalition',
      timeline: 'Within 24 hours',
      rationale: 'MAT discontinuation pattern (2x) suggests engagement barriers. Prior relationship with Tanya Williams is an asset.',
    },
    {
      priority: 'urgent',
      color: '#f97316',
      ...
      description: 'Emergency shelter stabilization + bridge to transitional housing. Shelter situation stable but precarious.',
      provider: 'Housing Authority of Lexington',
    ...
    },
    {
      ...
      description: 'Refer to co-occurring disorder counseling for depression + SUD. Target weekly sessions.',
      provider: 'Centerstone Kentucky',
      timeline: 'Within 2 weeks',
      rationale: 'PHQ-9 depression history + prior suicidal ideation. Co-occurring BH treatment increases MAT retention rates.',
    },
    {
      priority: 'short_term',
      color: '#22c55e',
      ...
      description: 'Re-refer to hepatology. Hep C treatment (Harvoni/Epclusa) can be initiated alongside MAT. Liver enzymes elevated.',
      provider: 'UK HealthCare + Fayette Co. Health Dept',
      timeline: 'Within 3 weeks',
      rationale: 'Elevated liver enzymes (ALT 145) indicate disease progression. Direct-acting antivirals are highly effective.',
    },
  ];
      ...
      {accepted && (
        <Card className="mb-4 border-green-200 bg-green-50 animate-fade-in">
          <CardContent className="p-4">
            ...
            <p className="text-xs text-green-600 mt-1">Each completed intervention will be logged as a HEAP event, updating Marcus's risk score in real-time.</p>
          </CardContent>
        </Card>
      )}
