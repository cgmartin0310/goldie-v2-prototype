...
import {
  ...
  LogOut, Activity, Settings, ChevronRight, Heart,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/provider/referrals', label: 'Referrals', icon: Inbox, badge: '12 new' },
  { to: '/provider/outcomes', label: 'Outcomes', icon: BarChart3 },
      ...
      <aside className="w-60 flex-shrink-0 flex flex-col" style={{ background: '#1a1a2e' }}>
        ...
        <div className="px-4 py-3 border-b border-white/5" style={{ background: 'rgba(212,168,67,0.06)' }}>
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0"
              ...
              <Heart className="w-3.5 h-3.5 text-[#D4A843]" />
            </div>
            <div className="min-w-0">
              <div className="text-[11px] font-semibold text-white truncate">Alliance Health</div>
              <div className="text-[10px] text-white/40 truncate">Treatment Provider</div>
            </div>
          </div>
          <div className="mt-2 flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
            <span className="text-[10px] text-white/40">Goldie Provider Network · 9 counties</span>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-white/10 space-y-0.5">
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg">
            ...
            <span className="text-xs text-white/30">Referral Engine Active</span>
          </div>
          ...
          >
            <div className="w-6 h-6 rounded-full bg-[#D4A843]/20 flex items-center justify-center">
              <span className="text-xs text-[#D4A843] font-medium">A</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="text-xs text-white/60 truncate">Alliance Health Admin</div>
            </div>
            <LogOut className="w-3.5 h-3.5 flex-shrink-0" />
          </div>
          <div className="px-3 py-1">
            <div className="text-[9px] text-white/20">Goldie Provider Network · 9 Counties</div>
          </div>
        </div>
      </aside>
